...
df = pd.read_csv("/Users/padaltiruvinayak/Desktop/Credit ML/Dataset/claimwise_50000.csv")
...
final_output.to_csv(
   "/Users/padaltiruvinayak/Desktop/Credit ML/Dataset/clean_one_hot_encoding_M2.csv",
   index=False
)
